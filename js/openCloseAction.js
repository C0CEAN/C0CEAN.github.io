class Accordion {
    constructor(el) {
        ...
        this.content = el.querySelector('.links'); //<div class="links"> element
    ...
    expand() {
        ...
        const endHeight = `${this.summary.offsetHeight + this.content.offsetHeight + 7}px`; //calculate the open height of the element (summary height + content height)
